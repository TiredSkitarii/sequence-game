...
let game = {
    score: 0,
    // Array storing the sequence of shapes generated by the game
    gameSequence: [],
...
function addTurn() {
    ...
    game.playerSequence = [];
    /* Randomly generates number between 0-3, uses number to identify shape in choices array,
     then pushes the id of shape correspoding to number to the gameSequence Array */
